...
# Get all members of the "French nouns" category
category_name = "French_nouns"
...
output_dataset = dataiku.Dataset("french_nouns_from_english_wiktionary")  # Change to your dataset name
