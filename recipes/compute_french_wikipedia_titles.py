...
# URL of the file
url = "https://dumps.wikimedia.org/frwikipedia/latest/frwikipedia-latest-all-titles.gz"
filename = "frwikipedia-latest-all-titles.gz"
unzipped_filename = "frwikipedia-latest-all-titles.txt"
...
output_dataset = dataiku.Dataset("french_wikipedia_titles")
