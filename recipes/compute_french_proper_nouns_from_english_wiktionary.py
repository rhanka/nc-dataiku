...
# Get all members of the "French_proper_nouns" category
category_name = "French_proper_nouns"
...
output_dataset = dataiku.Dataset("french_proper_nouns_from_english_wiktionary")  # Change to your dataset name
