...
# URL of the file
url = "https://dumps.wikimedia.org/enwikipedia/latest/enwikipedia-latest-all-titles.gz"
filename = "enwikipedia-latest-all-titles.gz"
unzipped_filename = "enwikipedia-latest-all-titles.txt"
...
output_dataset = dataiku.Dataset("english_wikipedia_titles")
